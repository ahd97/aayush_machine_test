...
import 'package:aayush_machine_test/core/di/api/interceptor/custom_interceptors.dart';
import 'package:aayush_machine_test/core/di/api/interceptor/internet_interceptor.dart';
...
class HttpClient {
  ...
  Future<dynamic> get(String url, {Map<String, dynamic>? data}) async {
    ...
    try {
      ...
      if (data != null) {
        final response = await _client.get(url, queryParameters: data);
